*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/SEW/INT_V_V
*   generation date: 17.03.2021 at 07:48:40
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/SEW/INT_V_V        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/SEW/INT_V_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /SEW/INT_V_V_EXTRACT
TOTAL = /SEW/INT_V_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/SEW/INT_V_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/SEW/INT_V_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /SEW/INT_V_V_EXTRACT
TOTAL = /SEW/INT_V_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/SEW/INT_V_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/SEW/INT_V_V'
...
TOTAL = /SEW/INT_V_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/SEW/INT_V_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/SEW/INT_V_V-UPD_FLAG NE SPACE.
