*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/SEW/INT_MF_V
*   generation date: 12.04.2021 at 17:46:15
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/SEW/INT_MF_V       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/SEW/INT_MF_V'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /SEW/INT_MF_V_EXTRACT
TOTAL = /SEW/INT_MF_V_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/SEW/INT_MF_V'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/SEW/INT_MF_V-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /SEW/INT_MF_V_EXTRACT
TOTAL = /SEW/INT_MF_V_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/SEW/INT_MF_V-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/SEW/INT_MF_V'
...
TOTAL = /SEW/INT_MF_V_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/SEW/INT_MF_V-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/SEW/INT_MF_V-UPD_FLAG NE SPACE.
