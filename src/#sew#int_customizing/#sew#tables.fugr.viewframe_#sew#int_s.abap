*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_/SEW/INT_S
*   generation date: 29.03.2021 at 14:21:13
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_/SEW/INT_S          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_/SEW/INT_S'
         EXPORTING
              FCODE          = READ
...
EXTRACT = /SEW/INT_S_EXTRACT
TOTAL = /SEW/INT_S_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_/SEW/INT_S'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_/SEW/INT_S-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = /SEW/INT_S_EXTRACT
TOTAL = /SEW/INT_S_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_/SEW/INT_S-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_/SEW/INT_S'
...
TOTAL = /SEW/INT_S_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_/SEW/INT_S-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_/SEW/INT_S-UPD_FLAG NE SPACE.
